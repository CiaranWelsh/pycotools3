...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_39" name="Function for ADeg" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_265" name="B" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_266" name="kADeg" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_40" name="Function for BProd" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_262" name="A" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_270" name="kBProd" order="1" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="model1" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m&#178;" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="AProd" reversible="false" fast="false" addNoise="false">
        ...
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=model1,Vector=Compartments[cell]">
      ...
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=model1,Vector=Reactions[AProd]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=model1,Vector=Reactions[AProd],ParameterGroup=Parameters,Parameter=v" value="0.10000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=model1,Vector=Reactions[ADeg]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=model1,Vector=Reactions[ADeg],ParameterGroup=Parameters,Parameter=kADeg" value="0.20000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 0 1 0.10000000000000001 0.20000000000000001 0.29999999999999999 0.40000000000000002 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_100" name="Time-Course" scheduled="false" type="timeCourse" update_model="false">
      <Report append="0" confirmOverwrite="0" reference="Report_30" target="D:\pycotools\Tests\model_selection\TimeCourseData.txt"/>
      <Problem>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_48" target="D:\pycotools\Tests\model_selection\negative_feedback\MultipleParameterEstimationResults\PEData0.txt"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter name="Number of steps" type="unsignedInteger" value="3"/><Parameter name="Type" type="unsignedInteger" value="0"/><Parameter name="Object" type="cn" value="CN=Root,Model=model1,Vector=Compartments[cell],Vector=Metabolites[B],Reference=InitialConcentration"/></ParameterGroup></ParameterGroup>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="0">
      <Report reference="Report_32" target="D:\pycotools\Tests\model_selection\negative_feedback\PEData.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Compartments[cell],Vector=Metabolites[A],Reference=InitialConcentration"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <ParameterGroup name="Affected Experiments"/>
            <Parameter name="LowerBound" type="cn" value="0.01"/>
            <Parameter name="UpperBound" type="cn" value="100.0"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Compartments[cell],Vector=Metabolites[B],Reference=InitialConcentration"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <ParameterGroup name="Affected Experiments"/>
            <Parameter name="LowerBound" type="cn" value="0.01"/>
            <Parameter name="UpperBound" type="cn" value="100.0"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Values[kADeg],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <ParameterGroup name="Affected Experiments"/>
            <Parameter name="LowerBound" type="cn" value="0.01"/>
            <Parameter name="UpperBound" type="cn" value="100.0"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Values[kBDeg],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <ParameterGroup name="Affected Experiments"/>
            <Parameter name="LowerBound" type="cn" value="0.01"/>
            <Parameter name="UpperBound" type="cn" value="100.0"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Values[kBProd],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <ParameterGroup name="Affected Experiments"/>
            <Parameter name="LowerBound" type="cn" value="0.01"/>
            <Parameter name="UpperBound" type="cn" value="100.0"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=model1,Vector=Values[vAProd],Reference=InitialValue"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
          ...
          <ParameterGroup name="Experiment_0">
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Compartments[cell],Vector=Metabolites[B],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="2">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Compartments[cell],Vector=Metabolites[A],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="3">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Values[kBDeg],Reference=Value"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="4">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Values[kBProd],Reference=Value"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="5">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Values[kADeg],Reference=Value"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="6">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=model1,Vector=Values[vAProd],Reference=Value"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
            </ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report taskType="parameterFitting" separator="&#9;" precision="6" key="Report_48" name="multi_parameter_estimation">
      <Comment/>
      <Table printTitle="1">
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/>
