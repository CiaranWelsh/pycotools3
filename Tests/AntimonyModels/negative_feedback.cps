...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_39" name="Function for AProd" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_261" name="B" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_262" name="cell" order="1" role="volume"/>
        <ParameterDescription key="FunctionParameter_263" name="vAProd" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_264" name="vBasalAProd" order="3" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_40" name="Function for BProd" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_250" name="kBProd" order="1" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_100" name="Time-Course" scheduled="true" type="timeCourse" update_model="false">
      <Report append="0" confirmOverwrite="0" reference="Report_30" target="D:\pycotools\Tests\AntimonyModels\TimeCourseData.txt"/>
      <Problem>
  ...
  <SBMLReference file="negative_feedback.sbml">
    ...
    <SBMLMap SBMLid="Function_for_AProd" COPASIkey="Function_39"/>
    <SBMLMap SBMLid="Function_for_BProd" COPASIkey="Function_40"/>
