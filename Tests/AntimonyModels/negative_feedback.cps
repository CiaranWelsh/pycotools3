...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-03-11 07:48:14 UTC -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_39" name="Function for BProd" type="UserDefined" reversible="false">
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_263" name="A" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_264" name="kBProd" order="1" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_40" name="Function for AProd" type="UserDefined" reversible="false">
      <Expression>
        (cell*vAProd*B+vBasalAProd)/cell
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_265" name="B" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_250" name="cell" order="1" role="volume"/>
        <ParameterDescription key="FunctionParameter_261" name="vAProd" order="2" role="constant"/>
        <ParameterDescription key="FunctionParameter_262" name="vBasalAProd" order="3" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="model1" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <ListOfCompartments>
  ...
  <SBMLReference file="negative_feedback.sbml">
    ...
    <SBMLMap SBMLid="Function_for_AProd" COPASIkey="Function_40"/>
    <SBMLMap SBMLid="Function_for_BProd" COPASIkey="Function_39"/>
