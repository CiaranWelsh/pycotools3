      ...
      <Problem>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment_0">
            ...
            <Parameter name="File Name" type="file" value="D:\pycotools\Tests\TimeCourseData.txt"/>
