...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_31" target="D:\pycotools\Tests\ProfileLikelihoods\0\ProfileLikelihoods\1\A2B.csv"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter name="Number of steps" type="unsignedInteger" value="4"/><Parameter name="Object" type="cn" value="CN=Root,Model=New_Model,Vector=Values[A2B],Reference=InitialValue"/><Parameter name="Type" type="unsignedInteger" value="1"/><Parameter name="Maximum" type="float" value="931.1181879999999"/><Parameter name="Minimum" type="float" value="0.0009292587412587412"/><Parameter name="log" type="bool" value="1"/></ParameterGroup></ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report precision="6" separator="&#9;" name="profile_likelihood" key="Report_31" taskType="Scan">
      <Comment/>
      <Table printTitle="1">
        <Object cn="CN=Root,Model=New_Model,Vector=Values[A2B],Reference=InitialValue"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/>
      </Table>
    </Report>
