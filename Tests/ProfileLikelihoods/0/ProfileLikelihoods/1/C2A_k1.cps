...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_31" target="D:\pycotools\Tests\ProfileLikelihoods\0\ProfileLikelihoods\1\C2A_k1.csv"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter name="Number of steps" type="unsignedInteger" value="4"/><Parameter name="Object" type="cn" value="CN=Root,Model=New_Model,Vector=Values[C2A_k1],Reference=InitialValue"/><Parameter name="Type" type="unsignedInteger" value="1"/><Parameter name="Maximum" type="float" value="521.0194989999999"/><Parameter name="Minimum" type="float" value="0.0005199790209790209"/><Parameter name="log" type="bool" value="1"/></ParameterGroup></ParameterGroup>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="LowerBound" type="cn" value="0.1"/>
            <Parameter name="UpperBound" type="cn" value="100"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New_Model,Vector=Values[ThisIsAssignment],Reference=InitialValue"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report precision="6" separator="&#9;" name="profile_likelihood" key="Report_31" taskType="Scan">
      <Comment/>
      <Table printTitle="1">
        <Object cn="CN=Root,Model=New_Model,Vector=Values[C2A_k1],Reference=InitialValue"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/>
      </Table>
    </Report>
