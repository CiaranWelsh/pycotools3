...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Model_3">
    ...
    <ListOfMetabolites>
      <Metabolite compartment="Compartment_1" key="Metabolite_3" name="B" simulationType="reactions" particle_number="1.25673046474e+22"/><Metabolite compartment="Compartment_1" key="Metabolite_1" name="A" simulationType="reactions" particle_number="8.15018477164e+15"/><Metabolite compartment="Compartment_1" key="Metabolite_5" name="C" simulationType="reactions"/></ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_2" name="ThisIsAssignment" simulationType="assignment" initial_value="670286.0"/><ModelValue key="ModelValue_1" name="B2C" simulationType="fixed" initial_value="4.29479"/><ModelValue key="ModelValue_0" name="A2B" simulationType="fixed"/></ListOfModelValues>
    <ListOfReactions>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4392" name="k2" value="81635.4"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="C2A" reversible="false" fast="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4391" name="k1" value="283868.0"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4390" name="k1" value="0.0862929"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">0.0 1.0 3.0 670286.0 4.29479 2.19203e-05 1.25673046474e+22 8.15018477164e+15 6.40526945832e+19 
</InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="0" updateModel="0">
      <Report reference="Report_32" target="/home/b3053674/Documents/pycotools/pycotools/Tests/PEData.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
