...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Model_3">
    ...
    <ListOfMetabolites>
      <Metabolite compartment="Compartment_1" key="Metabolite_3" name="B" simulationType="reactions" particle_number="1.63413201011e+17"/><Metabolite compartment="Compartment_1" key="Metabolite_1" name="A" simulationType="reactions" particle_number="1.19651507831e+15"/><Metabolite compartment="Compartment_1" key="Metabolite_5" name="C" simulationType="reactions" particle_number="8.7366810697e+19"/></ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_2" name="ThisIsAssignment" simulationType="assignment" initial_value="1.60611e-05"/><ModelValue key="ModelValue_1" name="B2C" simulationType="fixed" initial_value="10.4239"/><ModelValue key="ModelValue_0" name="A2B" simulationType="fixed" initial_value="0.181725"/></ListOfModelValues>
    <ListOfReactions>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4392" name="k2" value="1.40674e-05"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="C2A" reversible="false" fast="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4391" name="k1" value="43821.6"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4390" name="k1" value="6.65266"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">0.0 1.0 3.0 1.60611e-05 10.4239 0.181725 1.63413201011e+17 1.19651507831e+15 8.7366810697e+19 
</InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_15" name="Time-Course" scheduled="false" type="timeCourse" update_model="false"><Report append="0" confirmOverwrite="0" reference="Report_30" target=""/><Problem><Parameter name="AutomaticStepSize" type="bool" value="0"/><Parameter name="StepNumber" type="unsignedInteger" value="10"/><Parameter name="StepSize" type="float" value="100"/><Parameter name="Duration" type="float" value="1000"/><Parameter name="TimeSeriesRequested" type="float" value="1"/><Parameter name="OutputStartTime" type="float" value="0"/><Parameter name="Output Event" type="bool" value="0"/><Parameter name="Start in Steady State" type="bool" value="0"/></Problem><Method name="Deterministic (LSODA)" type="Deterministic(LSODA)"><Parameter name="Integrate Reduced Model" type="bool" value="0"/><Parameter name="Relative Tolerance" type="unsignedFloat" value="1e-06"/><Parameter name="Absolute Tolerance" type="unsignedFloat" value="1e-12"/><Parameter name="Max Internal Steps" type="unsignedInteger" value="10000"/><Parameter name="Max Internal Step Size" type="unsignedFloat" value="0"/></Method></Task><Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_95" target="C:\Users\Ciaran\Documents\pycotools\pycotools\Tests\ProfileLikelihoods\4\C.csv"/><Problem>
