...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Model_3">
    ...
    <ListOfMetabolites>
      <Metabolite compartment="Compartment_1" key="Metabolite_3" name="B" simulationType="reactions" particle_number="5.95398828892e+18"/><Metabolite compartment="Compartment_1" key="Metabolite_1" name="A" simulationType="reactions" particle_number="1.12290645062e+16"/><Metabolite compartment="Compartment_1" key="Metabolite_5" name="C" simulationType="reactions" particle_number="1.40320097467e+18"/></ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_2" name="ThisIsAssignment" simulationType="assignment" initial_value="1.06205e-06"/><ModelValue key="ModelValue_1" name="B2C" simulationType="fixed" initial_value="10.4074"/><ModelValue key="ModelValue_0" name="A2B" simulationType="fixed" initial_value="7.12533e-06"/></ListOfModelValues>
    <ListOfReactions>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4392" name="k2" value="386624.0"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="C2A" reversible="false" fast="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4391" name="k1" value="818243.0"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4390" name="k1" value="0.000107127"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[nuc]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">0.0 1.0 3.0 1.06205e-06 10.4074 7.12533e-06 5.95398828892e+18 1.12290645062e+16 1.40320097467e+18 
</InitialState>
  </Model>
  <ListOfTasks>
  ...
  <Report key="Report_30" name="Time-Course" precision="6" separator="&#9;" taskType="Time-Course"><Comment/><Table printTitle="1"><Object cn="CN=Root,Model=New Model,Reference=Time"/><Object cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[B],Reference=Concentration"/><Object cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[A],Reference=Concentration"/><Object cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[C],Reference=Concentration"/><Object cn="CN=Root,Model=New Model,Vector=Values[ThisIsAssignment],Reference=Value"/><Object cn="CN=Root,Model=New Model,Vector=Values[B2C],Reference=Value"/><Object cn="CN=Root,Model=New Model,Vector=Values[A2B],Reference=Value"/></Table></Report><Report taskType="parameterFitting" separator="&#9;" precision="6" key="Report_91" name="multi_parameter_estimation"><Comment/><Table printTitle="1"><Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/><Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/></Table></Report><Report taskType="parameterFitting" separator="&#9;" precision="6" key="Report_52" name="parameter_estimation"><Comment/><Footer><Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Parameters"/><Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/></Footer></Report></ListOfReports>
  <GUI>
  </GUI>
