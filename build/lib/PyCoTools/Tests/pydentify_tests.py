...
#        self.assertEqual(self.PL.PE_data.shape[0],int(self.S.kwargs.get('number_of_steps')))
#
...
#        PL=PyCoTools.pydentify2.ProfileLikelihood(self.copasi_file,parameter_path=self.PE_report_name)
#        self.assertTrue(isinstance(PL.read_PE_data(),pandas.core.frame.DataFrame))
#        
#    def test_read_PE_data_folder(self):
#        PL=PyCoTools.pydentify2.ProfileLikelihood(self.copasi_file,parameter_path=self.PE_dir)
#        self.assertTrue(isinstance(PL.read_PE_data(),pandas.core.frame.DataFrame))
#
...
#        PL=PyCoTools.pydentify2.ProfileLikelihood(self.copasi_file,index=0,parameter_path=self.PE_dir)
...
#        For this, no additional arguments are required.
#        '''
#        PL=PyCoTools.pydentify2.ProfileLikelihood(self.copasi_file,index=0,parameter_path=self.PE_file)
#        self.assertTrue(isinstance(PL.insert_parameters(),dict))        
#
...
#        For this, no additional arguments are required.
#        '''
#        PL=PyCoTools.pydentify2.ProfileLikelihood(self.copasi_file,index=[0,1,2],parameter_path=self.PE_dir)
#        self.assertTrue(isinstance(PL.insert_parameters(),dict)) 
#        
