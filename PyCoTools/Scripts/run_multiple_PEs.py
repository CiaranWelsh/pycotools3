...
import argparse
##==============================================================================
parser=argparse.ArgumentParser(description='run multiple parameter estimations by first copying the copasi file')
...
parser.add_argument('-M',help='Number of times to copy the model',default=4,type=int)
