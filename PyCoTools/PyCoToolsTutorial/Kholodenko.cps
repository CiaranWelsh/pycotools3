<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2017-06-29 19:38:28 UTC --><?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?><COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="19" versionDevel="140" copasiSourcesModified="0">
  <ListOfFunctions>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4386" name="n" value="1"/>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4384" name="V2" value="0.25"/>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4382" name="k3" value="0.025"/>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4379" name="KK4" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4378" name="V5" value="0.75"/>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4376" name="V6" value="0.75"/>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4373" name="KK7" value="15"/>
        </ListOfConstants>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4371" name="KK8" value="15"/>
        </ListOfConstants>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4369" name="KK9" value="15"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_9">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4368" name="V10" value="0.5"/>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Kholodenko2000 - Ultrasensitivity and negative feedback bring oscillations in MAPK cascade,Vector=Compartments[uVol],Vector=Metabolites[Mos]" value="5.419926771299999e+016" type="Species" simulationType="reactions"/>
  ...
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Kholodenko2000 - Ultrasensitivity and negative feedback bring oscillations in MAPK cascade,Vector=Compartments[uVol],Vector=Metabolites[Mos-P],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Minimum" type="float" value="1"/>
            <Parameter name="Number of steps" type="unsignedInteger" value="10"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Kholodenko2000 - Ultrasensitivity and negative feedback bring oscillations in MAPK cascade,Vector=Compartments[uVol],Vector=Metabolites[Mek1-P],Reference=InitialConcentration"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="log" type="bool" value="0"/>
          </ParameterGroup>
        </ParameterGroup>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="true" updateModel="false">
      <Report reference="Report_19" target="kholodenko_PE_results.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="279.9999999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="89.99999999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="9.999999999999998"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
