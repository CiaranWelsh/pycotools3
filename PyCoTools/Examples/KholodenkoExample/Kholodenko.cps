  ...
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4434" name="V1" value="2.5"/>
          <Constant key="Parameter_4435" name="Ki" value="9"/>
          <Constant key="Parameter_4436" name="n" value="1"/>
          <Constant key="Parameter_4437" name="K1" value="10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4438" name="V2" value="0.25"/>
          <Constant key="Parameter_4439" name="KK2" value="8"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4440" name="k3" value="0.025"/>
          <Constant key="Parameter_4441" name="KK3" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4442" name="k4" value="0.025"/>
          <Constant key="Parameter_4443" name="KK4" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4444" name="V5" value="0.75"/>
          <Constant key="Parameter_4445" name="KK5" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4446" name="V6" value="0.75"/>
          <Constant key="Parameter_4447" name="KK6" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4448" name="k7" value="0.025"/>
          <Constant key="Parameter_4449" name="KK7" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4450" name="k8" value="0.025"/>
          <Constant key="Parameter_4451" name="KK8" value="15"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4452" name="V9" value="0.5"/>
          <Constant key="Parameter_4453" name="KK9" value="15"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_9">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4454" name="V10" value="0.5"/>
          <Constant key="Parameter_4455" name="KK10" value="15"/>
        </ListOfConstants>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_11" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report append="false" confirmOverwrite="false" reference="Report_50" target="D:\MPhil\Python\My_Python_Modules\Modelling_Tools\PyCoTools\PyCoTools\Examples\KholodenkoExample\KholodenkoTimeCourseOutput.txt" type="Deterministic(LSODA)" name="Deterministic (LSODA)"/><Problem type="Deterministic(LSODA)" name="Deterministic (LSODA)">
