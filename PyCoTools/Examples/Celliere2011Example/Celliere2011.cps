<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2017-02-02 16:45:43 UTC --><?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?><COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  <ListOfFunctions>
...
<celldesigner:extension xmlns:celldesigner="http://www.sbml.org/2001/ns/celldesigner">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[h]" value="0.223549" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k1]" value="0.0318693" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k2]" value="4.54019e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k3]" value="59223.8" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k4]" value="637.699" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k7]" value="9.42672e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k8]" value="0.00953353" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k9]" value="0.000699539" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k10]" value="0.000113627" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k11]" value="21.8779" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k12]" value="1.284e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k13]" value="0.00164659" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k5]" value="185.315" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k6]" value="1.07311e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k14]" value="0.0329816" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k15]" value="2.21237e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k16]" value="0.0209666" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k17]" value="5.37297e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k18]" value="0.0343489" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Celliere2011 - Plasticity of TGF-beta Signalling,Vector=Values[k19]" value="1.13735e-06" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_57" target="" append="false" confirmOverwrite="false"/>
      <Problem>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="true" updateModel="false">
      <Report reference="Report_59" target="D:\MPhil\Python\My_Python_Modules\Modelling_Tools\PyCoTools\PyCoTools\Examples\Celliere2011Example\Celliere2011_PE_results.txt" append="0" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Maximize" type="bool" value="0"/>
