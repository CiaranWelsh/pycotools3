# -*- coding: utf-8 -*-
"""
Created on Mon Jan 30 21:55:57 2017
...
#        for i in range(len(inserted_parameters)):
#            print '\n'
#            print 'current:',inserted_parameters.keys()[i],'Value:',inserted_parameters[inserted_parameters.keys()[i]]
#            print 'inserted:',inserted_parameters.keys()[i],'Value:',test_dict[test_dict.keys()[i]]
#        print inserted_parameters==test_dict
    def tearDown(self):
        pass
