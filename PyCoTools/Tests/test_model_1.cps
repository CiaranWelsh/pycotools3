...
<!-- generated with COPASI 4.19 (Build 140) (http://www.copasi.org) at 2017-06-26 20:32:12 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[A]" value="6.022140856999999e+020" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[D]" value="6.022140857e+023" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[nuc],Vector=Metabolites[E]" value="6.022140856999999e+024" type="Species" simulationType="reactions"/>
    ...
    <InitialState type="initialState">
      0 3.011070895e+021 6.022140857e+023 6.022140856999999e+024 6.022140857e+022 6.022140856999999e+020 6.022140857e+025 2 1 5 15 1 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_19" target="MultipleParameterEstimationResults/ParameterFit1.txt" append="0" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.9999999999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="99.99999999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="5.000000774641462"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="9999.999999999998"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="999.9999999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Cross Validation Experiments">
            ...
            <Parameter name="StartValue" type="float" value="99999.99999999999"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
