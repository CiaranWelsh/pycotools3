...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_35" target="/home/ncw135/Documents/pycotools3/docs/source/Tutorials/Problem1/Fit1/model_name/ParameterEstimationData/PEData0.txt"/>
      <Problem>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="False">
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_first_dataset"/>
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1000000.0"/>
            <Parameter name="StartValue" type="float" value="model_value"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Compartments[cell],Vector=Metabolites[A],Reference=InitialConcentration"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_first_dataset"/>
            ...
            <Parameter name="UpperBound" type="cn" value="1000000.0"/>
            <Parameter name="StartValue" type="float" value="model_value"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Compartments[cell],Vector=Metabolites[B],Reference=InitialConcentration"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="first_dataset">
            <Parameter name="Key" type="key" value="Experiment_first_dataset"/>
            <Parameter name="File Name" type="file" value="/home/ncw135/Documents/pycotools3/docs/source/Tutorials/experimental_data.csv"/>
