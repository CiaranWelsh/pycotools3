...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_1" name="negative_feedback" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m&#178;" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="AProd" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4995" name="v" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="ADeg" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4994" name="kADeg" value="0.2"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="BProd" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4993" name="kBProd" value="0.3"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="BDeg" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4992" name="k1" value="0.4"/>
        </ListOfConstants>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" confirmOverwrite="0" reference="Report_55" target="D:\pycotools3\docs\source\Tutorials\Problem1\Fit1\negative_feedback\ParameterEstimationData\PEData0.txt"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter name="Number of steps" type="unsignedInteger" value="2"/><Parameter name="Type" type="unsignedInteger" value="0"/><Parameter name="Object" type="cn" value="CN=Root,Model=negative_feedback,Vector=Compartments[cell],Vector=Metabolites[A],Reference=InitialConcentration"/></ParameterGroup></ParameterGroup>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="0">
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_experimental_data"/>
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1000000.0"/>
            <Parameter name="StartValue" type="float" value="0.2"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Values[kADeg],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_experimental_data"/>
            ...
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1000000.0"/>
            <Parameter name="StartValue" type="float" value="0.4"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Values[kBDeg],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_experimental_data"/>
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Values[kBProd],Reference=InitialValue"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_experimental_data"/>
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Values[vAProd],Reference=InitialValue"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="experimental_data">
            <Parameter name="Key" type="key" value="Experiment_experimental_data"/>
            <Parameter name="File Name" type="file" value="D:\pycotools3\docs\source\Tutorials\experimental_data.csv"/>
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Compartments[cell],Vector=Metabolites[A],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
              <ParameterGroup name="2">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=negative_feedback,Vector=Compartments[cell],Vector=Metabolites[B],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
            </ParameterGroup>
          </ParameterGroup>
